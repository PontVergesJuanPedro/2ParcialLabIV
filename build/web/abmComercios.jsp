                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                                    <form id="formAltaComercio" method="POST" action="ABMComerciosServlet">
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text" class="form-control" id="nombre" name="nombreComercio">
                                        </div>
                                        <div class="form-group">
                                            <label for="descripcion">Descripción</label>
                                            <textarea id="descripcion" class="form-control" aria-label="With textarea" name="descripcionComercio"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="rubroComercio">Rubro</label>
                                            <select class="form-control" id="rubroComercio" name="rubroComercio">
                                ...
                                <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
                                    <form id="formLogin" method="POST" action="LoginServlet">
                                        ...
                                        <button type="submit" class="btn btn-primary">Modificar Comercio</button>
                                        <c:if test="${not empty errorLogin}">
                                            <div class="alert alert-warning mt-4" role="alert">
                                                <p>Error: ${errorLogin}</p> 
                                            </div>
